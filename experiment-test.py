...
model_dir = f'{folder_path}/HASS-DSI Input Type/{target_column}/Model Weights/'
history_folder = f'{folder_path}/HASS-DSI Input Type/{target_column}/Model Training History/'
results_folder = f'{folder_path}/Evaluation/HASS-DSI Input Type/{target_column}/'
probabilistic = False
